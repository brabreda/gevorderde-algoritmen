...
std::list<KortstePadStap> kortstePad(const KnooppuntGraaf &g, int start_nr, int eind_nr);


std::list<KortstePadStap> kortstePadBidirectioneel(const KnooppuntGraaf &g, int start_nr, int eind_nr);

#ifndef TESTING
std::vector<int> permanente_knoopnrs;
#endif